...
describe("intensity_scale_utils", () => {
  ...
  it("shows decimal labels for float auto mode when space allows", () => {
    expect(formatPixelLabelValue(1.2345, 40, "auto", "float32")).toBe("1.2345");
  ...
  it("falls back to scientific notation for float auto mode before rounding away fractions", () => {
    expect(formatPixelLabelValue(123456.789, 40, "auto", "float32")).toBe("1.23e5");
    expect(formatPixelLabelValue(1.2345, 18, "auto", "float32")).toBe("");
  });
